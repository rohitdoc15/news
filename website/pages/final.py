...
# Stopword list
stopwords = ['India News', 'Top Headlines', 'Viral Videos', 'National politics', 'Crime News', 'Hindi News', 'Weather Updates', 'Bihar News', 'R Bharat', 'World News', 'WION Shorts', 'News Events' , 'Delhi fire']
